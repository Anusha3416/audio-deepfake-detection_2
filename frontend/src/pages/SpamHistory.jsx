          ...
          {!loading && !error && items.length > 0 && (
            <>
              ...
              <div className="mt-6 px-6 py-5 rounded-b-2xl bg-neutral-950 border border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                  <p className="text-sm text-gray-400">If you believe this log contains fraud or deepfake activity, report it immediately to the government cyber crime portal.</p>
                  <p className="text-sm text-white font-semibold mt-2">Cyber Crime Helpline: <span className="text-red-400">1930</span></p>
                </div>
                <a
